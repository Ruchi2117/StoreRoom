...
def main():
    ...
    analysis = {"split":"val", "confidence":0.25, "matching_iou":0.5,
                ...
                "images":diagnostics}
    (ROOT / "reports/baseline_002_failure_analysis.json").write_text(json.dumps(analysis,indent=2)+"\n")
    ...
    for row in selected:
        ...
        pair.save(directory / f"baseline_002_val_{Path(row['image']).stem}.jpg",quality=92)
    ...
    sheet.save(directory / "baseline_002_validation.jpg",quality=92)
